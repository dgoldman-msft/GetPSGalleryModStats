...
Remove-Module GetPSGalleryModStats -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\GetPSGalleryModStats.psd1"
Import-Module "$PSScriptRoot\..\GetPSGalleryModStats.psm1" -Force
